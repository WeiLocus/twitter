...
`,r9=z.div`
  ...
  font-size: var(--fs-h3);
  font-weight: 700;
`;function o9(){const[e,t]=C.useState(""),[n,r]=C.useState(""),[o,i]=C.useState(""),[l,s]=C.useState(""),[a,u]=C.useState(""),[f,d]=C.useState(""),[m,y]=C.useState("取消重填"),[g,v]=C.useState(!1),x=n.length,h=tl.useMediaQuery({query:`(max-width: ${lr.md} )`}),p=Rt();C.useEffect(()=>{y(h?"取消重填":"取消")},[h]);const w=async()=>{if(e.trim().length===0||n.trim().length===0||o.trim().length===0||l.trim().length===0||a.trim().length===0){d("欄位不可空白!"),setTimeout(()=>{d(!1)},1e3);return}if(n.length>50){d("字數超過上限!"),setTimeout(()=>{d(!1)},1e3);return}if(l!==a){d("密碼與確認密碼不符!"),setTimeout(()=>{d(!1)},1e3);return}const{status:P,message:T}=await Jd({account:e,name:n,email:o,password:l,checkPassword:a});P!=="error"&&(v(!0),setTimeout(()=>{v(!1),p("/login")},1e3)),P==="error"&&T&&(d(T),setTimeout(()=>{d(!1)},1e3))},S=async P=>{if(P.key==="Enter"){if(e.length===0||n.length===0||o.length===0||l.length===0||a.length===0){d("欄位不可空白!"),setTimeout(()=>{d(!1)},1e3);return}if(n.length>50){d("字數超過上限!"),setTimeout(()=>{d(!1)},1e3);return}if(l!==a){d("密碼與確認密碼不符!"),setTimeout(()=>{d(!1)},1e3);return}const{status:T,message:O}=await Jd({account:e,name:n,email:o,password:l,checkPassword:a});T!=="error"&&(v(!0),setTimeout(()=>{v(!1),p("/login")},1e3)),T==="error"&&O&&(d(O),setTimeout(()=>{d(!1)},1e3))}};return _(lc,{children:[c("div",{children:c(Io,{})}),c(r9,{children:"建立你的帳號"}),c(Bt,{children:c(Ze,{label:"帳號",placeholder:"請輸入帳號",value:e,onChange:P=>t(P),onKeyDown:S})}),c(Bt,{children:c(Ze,{label:"名稱",placeholder:"請輸入使用者名稱",value:n,InputLength:x,onChange:P=>r(P),onKeyDown:S})}),c(Bt,{children:c(Ze,{label:"Email",placeholder:"請輸入Email",value:o,onChange:P=>i(P),onKeyDown:S})}),c(Bt,{children:c(Ze,{type:"password",label:"密碼",placeholder:"請設定密碼",value:l,onChange:P=>s(P),onKeyDown:S})}),c(Bt,{children:c(Ze,{type:"password",label:"密碼確認",placeholder:"請再次輸入密碼",value:a,onChange:P=>u(P),onKeyDown:S})}),c(sc,{name:"註冊",onClick:w}),c(Eo,{onClick:()=>{h?(t(""),r(""),i(""),s(""),u("")):p("/login")},children:m}),g&&c(tf,{children:c(Lt,{type:"success",message:"註冊成功 請登入"})}),f&&c(tf,{children:c(Lt,{type:"error",message:f})})]})}const nf=z.div`
  position: absolute;
  top: 10%;
  left: 50%;
  display: grid;
...
`,w9=z.div`
  ...
  place-items: center;
  z-index: 999;
`;function C9(){const[e,t]=C.useState([]),[n,r]=C.useState(!0),[o,i]=C.useState(""),l=Rt();C.useEffect(()=>{localStorage.getItem("adminToken")||l("/admin"),(async()=>{try{const d=await p9();t(d),r(!1)}catch(d){console.log(d)}})()},[]);const s=async u=>{if(window.confirm("確定要刪除這筆推文嗎？"))try{const{data:d,status:m}=await h9(u);d&&m===200&&(i("刪除一筆資料"),setTimeout(()=>{i(!1)},1e3)),t(y=>y.filter(g=>g.id!==u))}catch(d){console.log(d)}},a=e.map(u=>{if(!n)return c(S9,{tweet:u,onDelete:s},u.id)});return _(Be,{children:[c(Rr,{headerText:"推文清單"}),_(v9,{children:[o&&c(w9,{children:c(Lt,{type:"info",message:o})}),a,n&&c(y9,{children:c("div",{children:c(Rn,{color:"var(--color-theme)"})})})]})]})}function S9({tweet:e,onDelete:t}){const{id:n,description:r,createdAt:o,User:i}=e,{account:l,addname:s,avatar:a}=i,u=Vl(o),f=r.length>50?`${r.slice(0,50)}...`:r;return _(g9,{children:[c("img",{src:a,alt:"avatar"}),_("div",{children:[_("div",{className:"user",children:[c("b",{children:name}),_("span",{children:["@",l]}),c("span",{children:"．"}),c("span",{children:u})]}),c("p",{className:"content",children:f})]}),c("div",{className:"cross",children:c(_o,{onClick:()=>t(n)})})]})}const S0=e=>C.createElement("svg",{width:24,height:24,viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},C.createElement("path",{d:"M8.8 7.2002H5.6V3.9002C5.6 3.5002 5.3 3.1002 4.8 3.1002C4.3 3.1002 4.1 3.5002 4.1 3.9002V7.2002H0.8C0.4 7.2002 0 7.5002 0 8.0002C0 8.5002 0.3 8.8002 0.8 8.8002H4.1V12.1002C4.1 12.5002 4.4 12.9002 4.9 12.9002C5.4 12.9002 5.7 12.6002 5.7 12.1002V8.7002H9C9.4 8.7002 9.8 8.4002 9.8 7.9002C9.8 7.4002 9.3 7.2002 8.8 7.2002ZM23.8 2.3002V2.2002H23.7C23.6 2.2002 14.5 3.4002 9.3 13.9002C5.5 21.5002 5.7 23.8002 6 23.8002C6.3 23.9002 9.4 17.3002 12.7 14.6002C17.9 13.5002 19.3 11.0002 19.3 11.0002C19.3 11.0002 17.8 11.2002 17.2 11.2002C16.4 11.2002 15.8 11.0002 15.5 10.9002C16.8 9.7002 17.9 9.4002 19 9.2002C19.9 9.0002 20.8 8.8002 22 8.0002C24.2 6.4002 23.9 2.5002 23.8 2.3002Z",fill:"currentcolor"})),x9=z.div`
  display: grid;
...
`;function V9({tweetInput:e,currentUser:t,onClose:n,onChange:r,onAddTweet:o}){const{avatar:i}=t,[l,s]=C.useState(null),[a,u]=C.useState(!1),f=async m=>{if(m.key==="Enter"){if(u(!0),!e.trim().length){s("內容不可空白"),u(!1),setTimeout(()=>{s(null)},1e3);return}if(e.length>140){s("字數不可超過 140 字"),u(!1),setTimeout(()=>{s(null)},1e3);return}const{status:y}=await o();y==="ok"&&setTimeout(()=>{u(!1),s(null),n()},2e3)}},d=async m=>{if(m.preventDefault(),u(!0),!e.trim().length){s("內容不可空白"),u(!1),setTimeout(()=>{s(null)},1e3);return}if(e.length>140){s("字數不可超過 140 字"),u(!1),setTimeout(()=>{s(null)},1e3);return}const{status:y}=await o();y==="ok"&&setTimeout(()=>{u(!1),s(null),n()},2e3)};return C.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]),c(R0,{children:_(O0,{children:[_("div",{className:"close",children:[_("button",{type:"button",onClick:n,children:[c(_o,{className:"cross-icon"}),c(ac,{className:"goback-icon"})]}),c("button",{className:`submit-btn ${a?"disabled":void 0}`,type:"submit",onClick:d,children:a?"送出中...":"推文"})]}),_(b0,{children:[c("img",{src:i,alt:"avatar"}),_("form",{children:[c("textarea",{name:"tweet",id:"tweet-input",type:"text",placeholder:"有什麼新鮮事？",value:e,onChange:m=>{r==null||r(m.target.value)},onKeyDown:f}),_("div",{className:"submit",children:[c("span",{children:`${e.length}/140`}),_("div",{children:[c("span",{className:l?"error":void 0,children:l}),c("button",{className:a?"disabled":void 0,type:"submit",onClick:d,children:a?"送出中...":"推文"})]})]})]})]})]})})}function W9({tweet:e,currentUser:t,replyInput:n,onChange:r,onAddReply:o,onClose:i}){const{avatar:l}=t,{User:s,createdAt:a,description:u}=e,f=Vl(a),[d,m]=C.useState(!1),[y,g]=C.useState(null),v=async h=>{if(h.key==="Enter"){if(m(!0),!n.trim().length){g("內容不可空白"),m(!1);return}if(n.length>140){g("字數不可超過 140 字"),m(!1);return}const{status:p}=await o();p==="ok"&&setTimeout(()=>{m(!1),g(null),i()},2e3)}},x=async h=>{if(h.preventDefault(),m(!0),!n.trim().length){g("內容不可空白"),m(!1),setTimeout(()=>{g(null)},1e3);return}if(n.length>140){g("字數不可超過 140 字"),m(!1),setTimeout(()=>{g(null)},1e3);return}const{status:p}=await o();p==="ok"&&setTimeout(()=>{m(!1),g(null),i()},2e3)};return C.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]),c(R0,{children:_(O0,{reply:!0,children:[_("div",{className:"close",children:[_("button",{type:"button",onClick:i,children:[c(_o,{className:"cross-icon"}),c(ac,{className:"goback-icon"})]}),c("button",{className:`submit-btn ${d?"disabled":void 0}`,type:"submit",onClick:x,children:d?"送出中...":"回覆"})]}),_(H9,{children:[c("img",{src:s.avatar,alt:"avatar"}),_("div",{children:[_("div",{className:"user",children:[c("b",{children:s.name}),_("span",{children:["@",s.account]}),c("span",{children:"．"}),c("span",{children:f})]}),c("p",{className:"content",children:u}),_("div",{className:"reply-to",children:[c("span",{children:"回覆給"}),_("span",{className:"account",children:["@",s.account]})]})]})]}),_(b0,{children:[c("img",{src:l,alt:"avatar"}),_("form",{children:[c("textarea",{className:"reply-textarea",name:"reply",id:"reply-content",value:n,placeholder:"推你的回覆",onChange:h=>{r==null||r(h.target.value)},onKeyDown:v}),_("div",{className:"submit",children:[c("span",{children:`${n.length}/140`}),_("div",{children:[c("span",{className:y?"error":void 0,children:y}),c("button",{className:`submit-btn ${d?"disabled":void 0}`,type:"submit",onClick:x,children:d?"送出中...":"回覆"})]})]})]})]})]})})}const N0=z.nav`
  width: 100%;
  position: absolute;
  bottom: 0;
...
`;function m5({tweet:e,currentUser:t,replyInput:n,onChange:r,onAddReply:o}){const{id:i,description:l,createdAt:s,replyCounts:a,likeCounts:u,User:f}=e,{convertedDate:d,convertedTime:m}=u9(s),{userLikes:y,handleLike:g}=Ot(),[v,x]=C.useState(u),[h,p]=C.useState(!1),[w,S]=C.useState(!1),k=y.includes(i),P=()=>{p(!h)},T=async()=>{S(!0),await g(i),x(k?O=>O-1:O=>O+1),S(!1)};return _(Be,{children:[_(p5,{children:[_("div",{className:"user",children:[c(Ae,{to:`/users/${f.id}/tweets`,children:c("img",{src:f.avatar,alt:"avatar"})}),_("div",{children:[c("b",{children:f.name}),_("span",{children:["@",f.account]})]})]}),c("p",{className:"content",children:l}),_("div",{className:"time-stamp",children:[c("span",{children:m}),c("span",{children:"．"}),c("span",{children:d})]}),_("div",{className:"stats",children:[_("p",{children:[c("span",{children:a}),"回覆"]}),_("p",{children:[c("span",{children:v}),"喜歡次數"]})]}),_("div",{className:"reaction",children:[c("button",{type:"button",onClick:P,children:c(y0,{className:"icon"})}),c("button",{type:"button",className:w?"disabled":void 0,children:k?c(w0,{className:"icon",onClick:T}):c(uc,{className:"icon",onClick:T})})]})]}),_(h5,{className:"mobile-reply",onClick:P,children:[c("img",{src:t.avatar,alt:""}),c("p",{children:"推你的回覆"}),c("button",{type:"button",children:"回覆"})]}),h&&c(W9,{tweet:e,currentUser:t,replyInput:n,onChange:r,onAddReply:o,onClose:P})]})}const g5=z.div`
  height: calc(100vh - 60px);
  overflow-y: scroll;
  padding-top: 62px;
  padding-bottom: 60px;
...
`,P5=z.div`
  ...
  text-align: end;
  color: var(--color-error);
`;function L5({onClose:e,onProfileChange:t}){const n=tl.useMediaQuery({query:`(max-width: ${lr.md} )`}),{currentUser:r,handleUserUpdate:o}=Ot(),i={...r},[l,s]=C.useState(i.name),[a,u]=C.useState(i.introduction),[f,d]=C.useState(i.avatar),[m,y]=C.useState(i.cover),[g,v]=C.useState(i.avatar),[x,h]=C.useState(i.cover),[p,w]=C.useState(!1),[S,k]=C.useState(""),[P,T]=C.useState(!1),O=l.length,b=a.length,N=U=>{const ie=U.target.files[0],se=URL.createObjectURL(U.target.files[0]);v(ie),d(se)},Y=U=>{const ie=U.target.files[0],se=URL.createObjectURL(U.target.files[0]);h(ie),y(se)},K=async U=>{if(U.preventDefault(),w(!0),l.trim().length===0||a.trim().length===0){k("欄位不可空白!"),setTimeout(()=>{k(!1),w(!1)},1e3);return}if(l.length>50||a.length>160){k("字數超過上限!"),setTimeout(()=>{k(!1),w(!1)},1e3);return}const{data:ie,status:se}=await j9({id:r.id,name:l,introduction:a,avatar:g,cover:x});if(ie&&se===200){w(!1),T(!0);const Pe={...r,name:ie.name,introduction:ie.introduction,avatar:ie.avatar,cover:ie.cover};setTimeout(()=>{T(!1),e(),o(Pe),t()},1e3)}};return C.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]),_(x5,{children:[c(k5,{children:_("form",{onSubmit:K,encType:"multipart/form-data",children:[_(E5,{children:[c("button",{className:"close-btn",type:"button",onClick:e,children:c(_o,{})}),c("p",{children:"編輯個人資料"}),c("button",{className:`save-btn ${p?"disabled":void 0}`,type:"submit",children:p?"儲存中...":"儲存"})]}),_("div",{className:"content",children:[_("div",{className:"cover",children:[c("img",{src:m,alt:"user-cover"}),c(sf,{children:_("div",{className:"icons",children:[c("label",{htmlFor:"cover-input",children:c(of,{className:"icon"})}),c(_o,{className:"icon",onClick:e}),c("input",{className:"cover-input",name:"cover",id:"cover-input",placeholder:"none",type:"file",accept:"image/*",onChange:Y})]})})]}),_(_5,{children:[c(Ze,{label:"名稱",placeholder:"name",value:l,onChange:U=>s(U),InputLength:O}),_("div",{className:"introduction",children:[c("label",{children:"自我介紹"}),c(T5,{className:g0("",{error:b>160}),rows:n?"6":"3",placeholder:"Hello! My name is ...",value:a,onChange:U=>u(U.target.value)})]}),b>0&&_(v0,{children:[b,"/160"]}),b>160&&c(P5,{children:"字數超出上限！"})]}),_("div",{className:"avatar",children:[c("img",{src:f,alt:"avatar"}),c(sf,{children:_("div",{className:"icons",children:[c("label",{htmlFor:"avatar-input",children:c(of,{className:"icon"})}),c("input",{className:"avatar-input",id:"avatar-input",name:"avatar",placeholder:"none",type:"file",accept:"image/*",onChange:N})]})})]})]})]})}),S&&c(lf,{children:c(Lt,{type:"error",message:S})}),P&&c(lf,{children:c(Lt,{type:"success",message:"修改成功"})})]})}const R5=z.div`
  position: relative;
...
`;function $5({user:e,onProfileChange:t}){const{pathname:n}=yt(),{currentUser:r,userFollowings:o,handleFollow:i}=Ot(),{id:l,name:s,account:a,introduction:u,avatar:f,cover:d,followerCounts:m,followingCounts:y}=e,g=o.includes(l),[v,x]=C.useState(m),[h,p]=C.useState(!1),[w,S]=C.useState(!1);C.useEffect(()=>{x(g?T=>T+1:T=>T-1)},[g]);const k=()=>{p(!h)},P=async()=>{S(!0),await i(l),S(!1)};return _(Be,{children:[_(R5,{pathname:n,children:[c("div",{className:"cover",children:c("img",{src:d??"https://loremflickr.com/640/480/nature?lock=27430",alt:"user-cover"})}),c("img",{className:"avatar",src:f??"http://placekitten.com/g/500/500",alt:"avatar"}),_(O5,{children:[c(b5,{children:l===r.id?c("button",{type:"button",onClick:k,children:"編輯個人資料"}):_(Be,{children:[c("span",{className:"icon",children:c(C5,{})}),c("span",{className:"icon",children:c(S5,{})}),c("button",{className:`${g?"active":void 0} ${w?"disabled":void 0}`,type:"button",onClick:P,children:g?"正在跟隨":"跟隨"})]})}),_("div",{className:"user",children:[c("b",{children:s}),_("p",{children:["@",a]})]}),c("p",{className:"intro",children:u??"I like alpha camp"}),_("div",{className:"stats",children:[c(Ae,{to:`/users/${l}/followings`,children:l===r.id?_(Be,{children:[c("span",{children:o.length}),"個跟隨中"]}):_(Be,{children:[c("span",{children:y}),"個跟隨中"]})}),c(Ae,{to:`/users/${l}/followers`,children:l===r.id?_(Be,{children:[c("span",{children:m}),"個跟隨者"]}):_(Be,{children:[c("span",{children:v}),"個跟隨者"]})})]})]}),!n.includes("follow")&&_(N5,{children:[c(Ae,{className:"category",to:`/users/${l}/tweets`,children:c("p",{children:"推文"})}),c(Ae,{className:"category",to:`/users/${l}/replies`,children:c("p",{children:"回覆"})}),c(Ae,{className:"category",to:`/users/${l}/likes`,children:c("p",{children:"喜歡的內容"})})]})]}),h&&c(L5,{onClose:k,onProfileChange:t})]})}const A5=z.div`
  height: calc(100vh - 60px);
  overflow-y: scroll;
  padding-top: 68px;
  padding-bottom: 60px;
...
`,M5=z.div`
  ...
  border-inline: 2px solid var(--color-gray-200);
  color: var(--color-secondary);
`;function I5(){const{id:e}=_p();yt();const{currentUser:t}=Ot(),[n,r]=C.useState(t),[o,i]=C.useState([]),[l,s]=C.useState([]),[a,u]=C.useState([]),[f,d]=C.useState(!0),m=async()=>{d(!0);try{const y=await b9(e),g=await N9(e),v=await $9(e),x=await x0(e);r(y),i(g),s(v),u(x),d(!1)}catch(y){console.error(y)}};return C.useEffect(()=>{m()},[e]),_(Be,{children:[f&&c(M5,{children:c("div",{children:c(Rn,{color:"var(--color-theme)"})})}),!f&&_(Be,{children:[c(Rr,{headerText:n.name,user:n,goBack:!0,shownUserTweets:o}),_(A5,{children:[c("div",{className:"profile",children:c($5,{user:n,onProfileChange:m},n.id)}),c(ju,{context:{currentUser:t,shownUser:n,shownUserTweets:o,shownUserReplies:l,shownUserLikes:a}})]})]})]})}function j5(){const{shownUser:e,shownUserTweets:t}=No(),n=t.map(r=>c(dc,{tweet:r,shownUser:e},r.id));return c(jo,{children:n})}function D5(){const{shownUser:e,shownUserReplies:t}=No(),n=t.map(r=>c(C0,{reply:r,shownUser:e,replyTo:r.replyTo},r.id));return c(jo,{children:n})}function z5(){const{shownUserLikes:e}=No(),t=e.map(n=>c(dc,{tweet:n},n.id));return c(jo,{children:t})}const U5=z.ul`
...
`;function af(){const{pathname:e}=yt(),{userFollowings:t}=Ot(),{shownUser:n}=No(),[r,o]=C.useState(!0),[i,l]=C.useState([]),[s,a]=C.useState([]);let u;return e.includes("following")?u=i.map(f=>c(uf,{user:f},f.id)):u=s.map(f=>c(uf,{user:f},f.id)),C.useEffect(()=>{const f=async()=>{try{const d=await k0(n.id),m=await A9(n.id);l(d),a(m),o(!1)}catch(d){console.error(d)}};o(!0),f()},[t]),_(Be,{children:[c(V5,{id:n.id}),r?c(F5,{children:c("div",{children:c(Rn,{color:"var(--color-theme)"})})}):c(U5,{children:u})]})}function V5({id:e}){return _(H5,{children:[c(Ae,{className:"category",to:`/users/${e}/followers`,children:c("p",{children:"追隨者"})}),c(Ae,{className:"category",to:`/users/${e}/followings`,children:c("p",{children:"正在追隨"})})]})}function uf({user:e}){const{userFollowings:t,handleFollow:n}=Ot(),{id:r,name:o,account:i,avatar:l,introduction:s}=e,a=t.includes(r),[u,f]=C.useState(!1),d=async()=>{f(!0),await n(r),f(!1)};return _(B5,{children:[c(Ae,{to:`/users/${r}/tweets`,children:c("img",{src:l,alt:"avatar"})}),_("div",{children:[_("div",{className:"user",children:[c("b",{children:o}),_("p",{children:["@",i]}),c("button",{className:`${a?"active":void 0} ${u?"disabled":void 0}`,type:"button",onClick:d,children:a?"正在跟隨":"跟隨"})]}),c("p",{className:"content",children:s})]})]})}const W5="/twitter";function Q5(){return c(lv,{basename:W5,children:_(Ly,{children:[c(u2,{}),_(tv,{children:[c(Re,{path:"*",element:c(Uy,{})}),c(Re,{path:"login",element:c(t9,{})}),c(Re,{path:"signup",element:c(o9,{})}),_(Re,{path:"admin",children:[c(Re,{index:!0,element:c(l9,{})}),_(Re,{element:c(Z9,{}),children:[c(Re,{path:"tweets",element:c(C9,{})}),c(Re,{path:"users",element:c(L9,{})})]})]}),_(Re,{element:c(s5,{}),children:[_(Re,{path:"tweets",children:[c(Re,{index:!0,element:c(f5,{})}),c(Re,{path:":id",element:c(w5,{})})]}),c(Re,{element:c(I5,{}),children:_(Re,{path:"users/:id",children:[c(Re,{path:"tweets",element:c(j5,{})}),c(Re,{path:"replies",element:c(D5,{})}),c(Re,{path:"likes",element:c(z5,{})}),c(Re,{path:"followers",element:c(af,{type:"followers"})}),c(Re,{path:"followings",element:c(af,{type:"followings"})})]})}),c(Re,{path:"settings",element:c(U9,{})})]})]})]})})}bs.createRoot(document.getElementById("root")).render(c(Hn.StrictMode,{children:c(Q5,{})}));
