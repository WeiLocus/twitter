...
`;function m5({tweet:e,currentUser:t,replyInput:n,onChange:r,onAddReply:o}){const{id:i,description:l,createdAt:s,replyCounts:a,likeCounts:u,User:f}=e,{convertedDate:d,convertedTime:m}=u9(s),{userLikes:y,handleLike:g}=Ot(),[v,x]=C.useState(u),[h,p]=C.useState(!1),[w,S]=C.useState(!1),k=y.includes(i),T=()=>{p(!h)},P=async()=>{S(!0),await g(i),x(k?O=>O-1:O=>O+1),S(!1)};return _(Be,{children:[_(p5,{children:[_("div",{className:"user",children:[c(Ae,{to:`/users/${f.id}/tweets`,children:c("img",{src:f.avatar,alt:"avatar"})}),_("div",{children:[c("b",{children:f.name}),_("span",{children:["@",f.account]})]})]}),c("p",{className:"content",children:l}),_("div",{className:"time-stamp",children:[c("span",{children:m}),c("span",{children:"．"}),c("span",{children:d})]}),_("div",{className:"stats",children:[_("p",{children:[c("span",{children:a}),"回覆"]}),_("p",{children:[c("span",{children:v}),"喜歡次數"]})]}),_("div",{className:"reaction",children:[c("button",{type:"button",onClick:T,children:c(y0,{className:"icon"})}),c("button",{type:"button",className:w?"disabled":void 0,children:k?c(w0,{className:"icon",onClick:P}):c(uc,{className:"icon",onClick:P})})]})]}),_(h5,{className:"mobile-reply",onClick:T,children:[c("img",{src:t.avatar,alt:""}),c("p",{children:"推你的回覆"}),c("button",{type:"button",children:"回覆"})]}),h&&c(W9,{tweet:e,currentUser:t,replyInput:n,onChange:r,onAddReply:o,onClose:T})]})}const g5=z.div`
  height: calc(100vh - 60px);
  overflow-y: scroll;
  padding-top: 62px;
  padding-bottom: 60px;
